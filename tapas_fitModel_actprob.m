...
% ~~~~~~~~~~~~~~~~~~~~~~~~~
% CMG commenting out
r.c_obs = tapas_softmax_config;
% r.c_obs = tapas_bayes_optimal_binary_config; %tapas_logrt_linear_binary_config; 
...
r.optim.action_probs    = optres.action_probs;
r.optim.r_squared      = optres.r_squared; 
...
% --------------------------------------------------------------------------------------------------
function [negLogJoint, negLogLl, rval, err, trialLogLlsplit, action_probs, r_squared] = negLogJoint(r, prc_fun, obs_fun, ptrans_prc, ptrans_obs)
...
try
    ...
    [trialLogLls, dummy1, dummy2, trialLogLlsplit, action_probs, r_squared] = obs_fun(r, infStates, ptrans_obs);
catch
    % single response stream
    [trialLogLls, action_probs, r_squared] = obs_fun(r, infStates, ptrans_obs);
...
[negLj, negLl, dummy3, dummy4, trialLogLlsplit, action_probs, r_squared] = nlj(final);
...
optres.action_probs = action_probs;
optres.r_squared = r_squared;
