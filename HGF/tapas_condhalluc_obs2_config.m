...
% Modified by Carter Goldman to include two parameters that modulate the
% saliencey of the 4 types of observed stimuli (congruent/high_intensity=1,
% congruent/low_intensity=.75,incongruent/low_intensity=.25,
% incongruent/high_intensity=0)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
